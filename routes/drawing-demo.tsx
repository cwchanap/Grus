      ...
      <div class="container mx-auto p-4">
        ...
        <div class="mt-8 p-4 bg-gray-100 rounded-lg">
          ...
          <ul class="list-disc list-inside space-y-1 text-sm">
            <li><strong>Drawer Mode:</strong> You can draw, change colors, adjust brush size, clear canvas, and undo</li>
            <li><strong>Viewer Mode:</strong> You can only watch (no drawing tools available)</li>
            <li><strong>Disabled Mode:</strong> Drawing is completely disabled</li>
